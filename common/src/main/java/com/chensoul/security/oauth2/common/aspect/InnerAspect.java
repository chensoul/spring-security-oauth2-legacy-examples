package com.chensoul.security.oauth2.common.aspect;

import com.chensoul.security.oauth2.common.annotation.Inner;
import com.chensoul.security.oauth2.common.model.LoggedUser;
...
public class InnerAspect implements Ordered {
    ...
    public Object around(ProceedingJoinPoint point, Inner inner) {
        ...
        if (inner.value() && !StringUtils.equals("Y", header)) {
            LoggedUser cocktailUser = SecurityUtils.getUser();
            if (Objects.isNull(cocktailUser)) {
